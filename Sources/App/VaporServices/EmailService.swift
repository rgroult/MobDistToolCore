...
final class EmailService {
    enum ConfigKeys:String {
        case smtpServer,smtpLogin,smtpPassword,smtpSender,fakeMode,alternateEmailtemplateFile,confirmationPath,smtpPort,isSecured
    }
    ...
    func sendValidationEmail(for createdUser:User, into container:Container) throws -> Future<Void> {
        ...
        let html = generateMailContent(with: absoluteActivationUrl)
