...
final class EmailService {
    enum ConfigKeys:String {
        case smtpServer,smtpLogin,smtpPassword,smtpSender,fakeMode,alternateEmailtemplateFile,alternateResetPasswordEmailHtmlTemplate,alternateDisableUserEmailHtmlTemplate,confirmationPath,smtpPort,isSecured
    }
    ...
    let alternateDisableUserEmailHtmlTemplate:String? // template must contains a <%ACTIVATION_LINK%> to insert activation link
    ...
    init(with smtpConfig:[String:String], externalServerUrl:URL) throws{
        ...
        if let templateFile = smtpConfig[ConfigKeys.alternateResetPasswordEmailHtmlTemplate.rawValue]{
            ...
            //disable user
        if let templateFile = smtpConfig[ConfigKeys.alternateDisableUserEmailHtmlTemplate.rawValue]{
            alternateDisableUserEmailHtmlTemplate = try String(contentsOfFile: templateFile)
        }else {
            alternateDisableUserEmailHtmlTemplate = nil
        }
    ...
    private func generateDisableUserMailContent(with absoluteActivationUrl:String) -> String {
        if let template = alternateDisableUserEmailHtmlTemplate {
            return template.replacingOccurrences(of: "<%ACTIVATION_LINK%>", with: absoluteActivationUrl)
        }
        return """
          <html>
          <body>
            <div style='text-align: center'>
              <img src='data:image/png;base64,' />
              <span style='line-height:78px;'><b>Email verification</b></span>
            </div>
            <p style='text-align:center'>Your account is temporary disabled to check your email</p>
            <p style='text-align:center'>Please follow this <a href="\(absoluteActivationUrl)">link</a> to reactivate your account</p>
            <p style='text-align:center'>Regards</p>
          </body>
          </html>
        """
